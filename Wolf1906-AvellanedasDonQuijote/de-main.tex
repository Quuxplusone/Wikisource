...
\def\section#1 {#1}           % but center and letterspace
\def\emph#1 {#1}              % but letterspace
...
erschienen.\pfn{3}{\footnotetextp3n3}

In das Französische ist der {\it Don Quijote} Avellanedas zweimal\pfn{1}{\footnotetextp4n1}
und in das Englische drei- oder vielleicht richtiger nur zweimal
{\emph übersetzt} worden\pfn{2}{\footnotetextp4n2}.

Von der {\emph französischen Bearbeitung des Lesage} gibt
es sechs Ausgaben und ausserdem Übersetzungen ins Englische,
Holländische und Deutsche\pfn{1}{\footnotetext{p5n1}}.
...
conjeturar que quien fingió su patria, fingiría al nombre}\ldots}
...
beruhen (--- {\it la (affliccion) que debe tener este señor sin duda es grande\ldots})
...
es sich auf einen Studenten\pfn{1}{\footnotetextp7n1}
